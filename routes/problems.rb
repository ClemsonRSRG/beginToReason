...
aget '/problems/:module/:problem' do
...
# Code of the problem
aget '/problems/:module/:problem/code' do
	problems = client[:problems]
...
aget '/problems/:module/:problem/previous' do
	problems = client[:problems]
...
aget '/problems/:module/:problem/success' do
	problems = client[:problems]
...
aget '/problems/:module/:problem/failure' do
	problems = client[:problems]
