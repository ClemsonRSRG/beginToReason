...
`BeginToReason` is a tool that utilizes the RESOLVE programming language to pinpoint difficulties CS students have with learning how to rigorously trace the code they encounter. It is a NodeJS app that uses Bootstrap and communicates with the RESOLVE verification engine.
...
Developers of this particular test/working-iteration of the `BeginToReason` include:
